...
#define GIOT_PROJECT_ID "scaf-291004"
#define GIOT_LOCATION "us-central1"
#define GIOT_REGISTRY_ID "iotcore-registry"
#define GIOT_DEVICE_ID "esp32"
...
static void wifi_init(void)
{
    ...
    ESP_LOGI(TAG, "start the WIFI SSID:[%s]", ESP_WIFI_SSID);
                             ...
                             iotc_timed_task_handle_t timed_task, void *user_data)
{
    ...
    asprintf(&publish_message, TEST_MESSAGE);
